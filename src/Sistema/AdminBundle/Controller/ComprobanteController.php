...
use Sistema\AdminBundle\Entity\Comprobante;
use Sistema\AdminBundle\Form\ComprobanteType;
use Sistema\AdminBundle\Form\ComprobanteFilterType;
...
class ComprobanteController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new ComprobanteFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('SistemaAdminBundle:Comprobante')->createQueryBuilder('e');
        ...
        if ($request->getMethod() == 'POST' && $request->get('filter_action') == 'filter') {
            ...
            if ($session->has('ComprobanteControllerFilter')) {
                ...
                $filterForm = $this->createForm(new ComprobanteFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('comprobante', array('page' => $page));
        };
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SistemaAdminBundle:Comprobante')->find($id);
     ...
     * @Method("post")
     * @Template("SistemaAdminBundle:Comprobante:new.html.twig")
     */
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('comprobante_show', array('id' => $entity->getId())));        } else {
     ...
     * @Method("post")
     * @Template("SistemaAdminBundle:Comprobante:edit.html.twig")
     */
